...
def inference(net, image, conf_thresh=0.5, iou_thresh=0.4, target_shape=(260, 260), draw_result=True, chinese=False):
    ...
    for idx in keep_idxs:
        ...
        position=(bbox[3],bbox[2],bbox[1],bbox[0])
        #[face postion,mask or not,confidence]
        detect_results.append([position,class_id,conf])
